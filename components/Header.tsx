    ...
    <div className="items-center">
      <nav className="flex items-center flex-wrap bg-white p-3 relative">
        ...
        <div className={`${active ? '' : 'hidden'}   w-full lg:inline-flex lg:flex-grow lg:w-auto`}>
          <div className="inline-flex rounded-3xl items-center max-w-fit border border-solid border-gray-300 ml-36 shadow-lg ">
            <input
              type="text"
              placeholder="search.."
              className="border-none ml-3 focus:outline-none focus:border-white-100 items-center "
            />
             <svg
              class="w-5 h-5 "
              fill="none"
